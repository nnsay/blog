...
- 岗位: AI 应用开发, DevOps, 后端开发
- 技能:
  - 开发语言: Node.js, Golang, Python, TypeScript
  - AI 工程: RAG, Agent, 模型微调, 推理部署 (vLLM / SGLang)
  - 云原生: Kubernetes, Docker, CI/CD
  - IaC: Terraform, AWS CDK, 阿里云 ROS
  - 公有云: Aliyun, AWS
- Github: [nnsay](https://github.com/nnsay)
- 简历: [简历(2026-07)](/about/index/resume.pdf)
- 求职地址: 北京, 西安
...
- 私有化 AI 交付: 主导 301 所私有化 RAG 系统落地, 完成从文档上传到智能问答的完整闭环
- 跨云迁移与降本: 主导 AWS 到阿里云全量迁移, 微服务资源调度优化降低云成本 40%+
- 阿里云 ACP 认证
